          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
              <div>
                ...
                <p className="text-white text-sm font-medium">Solo Product Designer &amp; Builder</p>
              </div>
              <div>
                <p className="text-[#A7AAB4] text-xs tracking-widest font-medium mb-1">TIMELINE</p>
                <p className="text-white text-sm font-medium">2–3 weeks, idea to deployed</p>
              </div>
              <div>
                <p className="text-[#A7AAB4] text-xs tracking-widest font-medium mb-1">TECH</p>
                <p className="text-white text-sm font-medium">Claude Code · Three.js · MediaPipe · Claude API</p>
              </div>
              <div>
            ...
            <div className="space-y-16 pb-16">
              ...
              <section id="rl-section-02">
                ...
                {/* Quote block */}
                <blockquote className="border-l-2 border-[#00F48D] pl-4 my-6">
                  <p className="text-[#A7AAB4] text-sm leading-7 italic">
                    "I never actually read the whole paper. I'm always trying to find where the useful bit is." — MSc student, Kingston University
                  </p>
                </blockquote>

                <h3 className="text-white text-base font-semibold mt-8 mb-4">Competitive audit</h3>

                <div className="space-y-6">
                  <div>
                    <p className="text-white text-sm font-semibold mb-2">NotebookLM (Google)</p>
                    <ul className="space-y-1 text-[#A7AAB4] text-sm leading-7">
                  ...
                  <div>
                    <p className="text-white text-sm font-semibold mb-2">Obsidian + Plugins</p>
                    <ul className="space-y-1 text-[#A7AAB4] text-sm leading-7">
                ...
                <h3 className="text-white text-base font-semibold mt-8 mb-3">Key insight that drove all decisions</h3>
              ...
              <section id="rl-section-03">
                ...
                <h3 className="text-white text-base font-semibold mb-3">Success looks like</h3>
                <ul className="space-y-2 text-[#A7AAB4] text-sm leading-7">
              ...
              <section id="rl-section-04">
                ...
                <h3 className="text-white text-base font-semibold mb-3">Information architecture</h3>
                <p className="text-[#A7AAB4] text-sm leading-7 mb-4">
                  Three node types were defined based on the natural structure of academic papers:
                </p>
                <ul className="space-y-2 text-[#A7AAB4] text-sm leading-7 mb-8">
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Sections</span> — the paper's own structural divisions (Abstract, Introduction, Methodology, Results, Discussion, Conclusion)</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Concepts</span> — key terms, theories, methods, and technical entities the paper introduces or relies upon</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Claims</span> — specific findings, arguments, hypotheses, and contributions the paper asserts</span></li>
                </ul>
                <p className="text-[#A7AAB4] text-sm leading-7 mb-8">
                ...
                <h3 className="text-white text-base font-semibold mb-3">The design rationale — Three topology views</h3>
                <p className="text-[#A7AAB4] text-sm leading-7 mb-4">Three views, same data, different structural lens.</p>
                <ul className="space-y-2 text-[#A7AAB4] text-sm leading-7 mb-4">
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Centralised</span> — one idea at the centre, all others radiating by semantic distance. What is this paper fundamentally about?</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Decentralised</span> — ideas grouped into thematic clusters. What are the major themes and what bridges them?</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Distributed</span> — peer-to-peer connections, no hierarchy. How do individual ideas actually relate?</span></li>
                </ul>
                <p className="text-[#A7AAB4] text-sm leading-7 mb-8">
                  Same paper. Three interpretations. Navigable in real time. No other research tool does this.
                </p>

                <h3 className="text-white text-base font-semibold mb-4">Key design decisions</h3>
                <div className="space-y-4 text-[#A7AAB4] text-sm leading-7">
                  <p>
              ...
              <section id="rl-section-05">
                ...
                <h3 className="text-white text-base font-semibold mb-3">Stack decisions</h3>
                <ul className="space-y-2 text-[#A7AAB4] text-sm leading-7 mb-8">
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Three.js r128</span> — 3D rendering with CSS2DRenderer for always-visible labels</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">MediaPipe Hands + Face Mesh</span> — gesture and blink detection, fully client-side</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Claude API (claude-sonnet-4)</span> — 4 sequential calls: clustering, layout, edges, analysis</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">PDF.js</span> — client-side text extraction up to 30 pages</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Vanilla JS</span> — no framework, minimal bundle, fast load on low-powered hardware</span></li>
                </ul>

                <h3 className="text-white text-base font-semibold mb-3">Design decisions that changed at code</h3>
                <ul className="space-y-2 text-[#A7AAB4] text-sm leading-7">
              ...
              <section id="rl-section-06">
                ...
                <div className="space-y-4 text-[#A7AAB4] text-sm leading-7">
                  <p>
                    <span className="text-white font-semibold">Upload Screen</span> — A focused single-action screen. Logo, tagline, drop zone, API key field. Optical centre placement (42% from top) rather than mathematical centre — a small detail that makes the screen feel intentional rather than accidental.
                  </p>
                  <p>
                    <span className="text-white font-semibold">Loading Screen</span> — Six-step progress indicator with the paper title shown, a progress bar with fraction count, and an estimated time hint. Designed to prevent the "did it crash?" moment that kills trust in AI tools on first use.
                  </p>
                  <p>
                  ...
                  <p>
                    <span className="text-white font-semibold">3D Spatial View</span> — Webcam as full background, Three.js canvas transparent on top. Three topology modes with 1.2s eased morph animation. Hand gesture guide bottom-left, active gesture highlighted in real time. Eye blink toggle in nav bar for accessibility.
                  </p>
                </div>
              </section>
              ...
              <section id="rl-section-07">
                ...
                <div className="space-y-6">
                  <blockquote className="border-l-2 border-[#00F48D] pl-4">
                    ...
                    <p className="text-[#A7AAB4] text-xs mt-2">— PhD candidate, on the mindmap view</p>
                  </blockquote>
                  <blockquote className="border-l-2 border-[#00F48D] pl-4">
                    <p className="text-[#A7AAB4] text-sm leading-7 italic">
                      "The 3D view is genuinely different from anything I've seen in a research tool. It feels like you're inside the paper."
                    </p>
                    <p className="text-[#A7AAB4] text-xs mt-2">— Independent UX researcher</p>
                  </blockquote>
                </div>
              </section>
              ...
              <section id="rl-section-08">
                ...
                <h3 className="text-white text-base font-semibold mb-3">Near term — Freemium model</h3>
                <ul className="space-y-2 text-[#A7AAB4] text-sm leading-7 mb-8">
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Free tier</span> — 3 paper analyses per month using a shared key pool</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Pro tier (£4.99/month)</span> — unlimited papers, multi-paper comparison, longer papers (50 pages), export to Notion/Obsidian</span></li>
                  <li className="flex gap-2"><span>•</span><span><span className="text-white font-semibold">Team tier (£12/month per seat)</span> — shared workspaces, annotated maps, collaborative Ask Claude sessions</span></li>
                </ul>

                <h3 className="text-white text-base font-semibold mb-3">Revenue path</h3>
                <p className="text-[#A7AAB4] text-sm leading-7">
