      ...
      >
        ...
        <div className="sticky top-0 z-20 bg-[var(--panel)] border-b border-[var(--border)] px-6 py-3 flex items-center justify-between">
          ...
          <span className="hidden md:block text-xs font-medium tracking-wide max-w-sm truncate">
            <span className="text-[var(--text-muted)]">Case Study / </span>
            <span className="text-[var(--text)]">BlinkSpeak (Supported by Published research paper)</span>
          </span>
          <div className="flex items-center gap-2">
            <span className="bg-[var(--accent)]/10 border border-[var(--accent)]/30 text-[var(--accent)] px-2.5 py-1 rounded-md text-xs font-semibold">
              IEEE Published
            </span>
        ...
        <div className="relative flex gap-8 px-6 pt-10 md:pt-12 pb-0 w-full mx-auto md:max-w-212.5">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-6">
              <div>
                <p className="text-[var(--text-muted)] text-xs tracking-widest font-medium mb-1">PUBLISHED</p>
                <p className="text-[var(--text)] text-sm font-medium">IEEE I2CT 2024</p>
              </div>
              <div>
                <p className="text-[var(--text-muted)] text-xs tracking-widest font-medium mb-1">MY ROLE</p>
                <p className="text-[var(--text)] text-sm font-medium">Solo Designer &amp; Builder</p>
              </div>
              <div>
                <p className="text-[var(--text-muted)] text-xs tracking-widest font-medium mb-1">TECH</p>
                <p className="text-[var(--text)] text-sm font-medium">Claude Code · React · FastAPI · MediaPipe</p>
              </div>
              <div>
            ...
            {/* Intro paragraph */}
            <p className="text-[var(--text-muted)] text-sm leading-7 mb-16">
            ...
            <div className="space-y-16 pb-16">
              ...
              <section id="bs-section-01">
                ...
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-4">Progressive paralysis silences people. Technology shouldn&apos;t.</h2>
              ...
              <section id="bs-section-02">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">02&nbsp;&nbsp;Role &amp; Constraints</p>
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-4">Built under real constraints, not ideal ones.</h2>

                <div className="space-y-8 text-[var(--text-muted)] text-sm leading-7">
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">01 Team</p>
                  ...
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">02 Tech constraint</p>
                  ...
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">03 Time</p>
                    <p>Research-to-prototype: ~3 weeks. Web port to browser-native stack: iterative sprints alongside IEEE submission deadlines.</p>
                  </div>
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">04 Budget</p>
              ...
              <section id="bs-section-03">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">03&nbsp;&nbsp;Research &amp; Insight</p>
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-4">Five approaches. One clear winner for ALS patients.</h2>
                <div className="space-y-4 text-[var(--text-muted)] text-sm leading-7">
                  <p>
                  ...
                  <p>
                    <span className="text-[var(--text)] font-semibold">Key insight:</span> Eye blinking is the only method that requires no external hardware, no assistive person, and can be implemented in pure software on any device with a camera. For patients in low-income contexts, it is the only viable path.
                  </p>
                </div>
              </section>
              ...
              <section id="bs-section-04">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">04&nbsp;&nbsp;The Core User Need</p>
                <div className="space-y-4 text-[var(--text-muted)] text-sm leading-7">
                  <p>
                  ...
                  <p>
                    <span className="text-[var(--text)] font-semibold">Success:</span> a patient sitting alone at a laptop, composing &ldquo;HELLO&rdquo; in under 60 seconds, sending it to a family member on WhatsApp with no one else in the room, and nothing bought.
                  </p>
                </div>
              </section>
              ...
              <section id="bs-section-05">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">05&nbsp;&nbsp;Design Process</p>
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-6">From EAR formula to browser-native interaction.</h2>

                <div className="space-y-8 text-[var(--text-muted)] text-sm leading-7 mb-10">
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">01 Algorithm first, interface second</p>
                  ...
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">02 Information architecture — what must be visible at all times</p>
                  ...
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">03 Live-tunable calibration</p>
                  ...
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">04 Browser-native stack</p>
                ...
                <h3 className="text-[var(--text)] text-base font-semibold mb-6">Key Design Decisions</h3>
                <div className="space-y-8 text-[var(--text-muted)] text-sm leading-7">
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">01 Dark terminal aesthetic, not a medical app aesthetic</p>
                  ...
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">02 No keyboard fallback — blinks only during active session</p>
                  ...
                  <div>
                    <p className="text-[var(--accent)] font-semibold text-xs tracking-wider uppercase mb-2">03 Morse reference always visible, never modal</p>
              ...
              <section id="bs-section-06">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">06&nbsp;&nbsp;The Build</p>
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-4">Vibe-coded with precision.</h2>
                <div className="space-y-4 text-[var(--text-muted)] text-sm leading-7">
                  <p>
                  ...
                  <p>
                    <span className="text-[var(--text)] font-semibold">The constraint that made it better:</span> Dlib failing to install in the deployment environment forced the MediaPipe JS migration. The result works on any browser, any webcam, any OS, with one click. The constraint was a gift.
                  </p>
                </div>
              </section>
              ...
              <section id="bs-section-07">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">07&nbsp;&nbsp;The Product</p>
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-4">Four panels. One purpose.</h2>
                <div className="space-y-4 text-[var(--text-muted)] text-sm leading-7">
                  <p>
                    <span className="text-[var(--text)] font-semibold">Live Feed:</span> WebRTC stream with EAR overlaid in green. Open/closed state indicator. Browser inference at 30fps — no server round-trip.
                  </p>
                  <p>
                    <span className="text-[var(--text)] font-semibold">Morse Buffer:</span> Dots as filled circles, dashes as rectangles, animated in as registered. In-progress symbol pulses — immediate confirmation before letter commits.
                  </p>
                  <p>
                    <span className="text-[var(--text)] font-semibold">Decoded Message:</span> Typewriter animation per character. Speak (Web Speech API), WhatsApp (FastAPI backend), Copy, Clear.
                  </p>
                  <p>
                    <span className="text-[var(--text)] font-semibold">Controls:</span> EAR threshold (0.20–0.35) and dot/dash duration (5–20 frames) tunable live without restarting — critical for patients with atypical blink physiology.
                  </p>
                </div>
              </section>
              ...
              <section id="bs-section-08">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">08&nbsp;&nbsp;Results &amp; Impact</p>
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-4">Tested. Published. Deployed.</h2>
              ...
              <section id="bs-section-09">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">09&nbsp;&nbsp;Monetisation Strategy</p>
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-4">Free for patients. Sustainable by design.</h2>
                <p className="text-[var(--text-muted)] text-sm leading-7">
              ...
              <section id="bs-section-10">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">10&nbsp;&nbsp;Future Work</p>
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-4">Roadmap driven by patient need.</h2>
              </section>

              {/* 11 Learnings */}
              <section id="bs-section-11">
                <p className="text-[var(--accent)] font-semibold text-sm tracking-wider uppercase mb-3">11&nbsp;&nbsp;Learnings</p>
                <h2 className="text-[var(--text)] text-xl md:text-2xl font-bold mb-6">Built under real constraints, not ideal ones.</h2>

                <div className="space-y-8 text-[var(--text-muted)] text-sm leading-7">
                  <div>
                    <h3 className="text-[var(--text)] text-base font-semibold mb-3">What building taught me about design</h3>
                    <p>
                  ...
                  <div>
                    <h3 className="text-[var(--text)] text-base font-semibold mb-3">What design taught me about building</h3>
                    <p>
                  ...
                  <div>
                    <h3 className="text-[var(--text)] text-base font-semibold mb-3">Key takeaway</h3>
                    <p>
